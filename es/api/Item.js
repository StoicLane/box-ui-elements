...
function (_Base) {
  ...
  _createClass(Item, [{
     ...
     * @return {void}
     */
    value: function validateSharedLinkRequest(itemID, itemPermissions) {
      var canSkipSetShareAccessPermission = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    ...
    value: function () {
      ...
      successCallback) {
        var errorCallback,
            ...
            permissions,
            sharedLink,
            canSkipSetShareAccessPermission,
            fields,
            requestData,
            _ref2,
            data,
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                _context.prev = 4;
                id = item.id, permissions = item.permissions, sharedLink = item.shared_link;
                this.id = id;
                this.successCallback = successCallback;
                this.errorCallback = errorCallback; // skip permission check when creating links with default access level

                canSkipSetShareAccessPermission = !sharedLink && access === undefined;
