...
function () {
  ...
  _createClass(APIFactory, [{
    ...
    key: "getThreadedCommentsAPI",
    value: function getThreadedCommentsAPI(shouldDestroy) {
      if (shouldDestroy) {
        this.destroy();
      }
    ...
    key: "getFileActivitiesAPI",
    value: function getFileActivitiesAPI(shouldDestroy) {
      if (shouldDestroy) {
        this.destroy();
      }
