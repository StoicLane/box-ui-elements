...
function (_MarkerBasedAPI) {
  ...
  function FileCollaborators() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getCollaboratorsWithQuery", function (fileId, successCallback, errorCallback, searchStr) {
      var _ref = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : {},
          _ref$includeGroups = _ref.includeGroups,
          includeGroups = _ref$includeGroups === void 0 ? false : _ref$includeGroups;
      ...
      _this.getFileCollaborators(fileId, successCallback, errorCallback, {
