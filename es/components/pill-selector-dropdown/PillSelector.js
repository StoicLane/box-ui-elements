...
var PillSelectorBase =
/*#__PURE__*/
function (_React$Component) {
  _inherits(PillSelectorBase, _React$Component);

  function PillSelectorBase() {
    var _getPrototypeOf2;

    var _this;

    _classCallCheck(this, PillSelectorBase);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(PillSelectorBase)).call.apply(_getPrototypeOf2, [this].concat(args)));
...
var PillSelector = React.forwardRef(function (props, ref) {
  return React.createElement(PillSelectorBase, _extends({}, props, {
    innerRef: ref
  }));
});
