...
describe('components/search-form/SearchForm', function () {
  ...
  describe('onSubmitHandler()', function () {
    ...
    test('should call onsubmit on form submit event', function () {
      var wrapper = mount(React.createElement(SearchForm, {
    ...
    test('should call onsubmit on search icon button submit event', function () {
      var wrapper = mount(React.createElement(SearchForm, {
        onSubmit: onSubmitMock,
        placeholder: "search",
        value: "cheese"
      }));
      var searchButton = wrapper.find('.search-button');
