...
function (_React$Component) {
  _inherits(SearchFormBase, _React$Component);
  ...
  function SearchFormBase() {
    ...
    _classCallCheck(this, SearchFormBase);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(SearchFormBase)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(SearchFormBase, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          rest = _objectWithoutProperties(_this$props2, ["action", "className", "innerRef", "intl", "isLoading", "method", "name", "queryParams", "onSubmit", "useClearButton"]);
...
var SearchFormBaseIntl = injectIntl(SearchFormBase);
export { SearchFormBaseIntl };
var SearchForm = React.forwardRef(function (props, ref) {
  return React.createElement(SearchFormBaseIntl, _extends({}, props, {
    innerRef: ref
  }));
});
