...
var PopperComponent = function PopperComponent(props) {
  var children = props.children,
      _props$isPositionDyna = props.isPositionDynamic,
      isPositionDynamic = _props$isPositionDyna === void 0 ? true : _props$isPositionDyna,
      isOpen = props.isOpen,
  ...
  return React.createElement(Manager, null, React.createElement(Reference, null, function (_ref) {
    ...
    return React.cloneElement(popperContent, {
      ref: ref,
      style: _objectSpread({}, contentStyles, {}, isPositionDynamic && style),
      placement: placement,
