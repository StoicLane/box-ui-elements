  ...
  _createClass(Menu, [{
    ...
    value: function componentDidUpdate(_ref2) {
      ...
      if (React.Children.toArray(prevChildren).length !== React.Children.toArray(children).length) {
        ...
        var isFocusedElementMissing = menuIndex === -1;
        var isFocusIndexOutOfBounds = this.focusIndex >= this.menuItemEls.length;
    ...
    value: function render() {
      ...
      return React.createElement("ul", menuProps, React.createElement(MenuContext.Provider, {
        value: {
