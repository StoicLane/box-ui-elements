...
var SUBMENU_RIGHT_BOTTOM_ALIGNED_CLASS = 'is-right-bottom-aligned';
...
function (_React$Component) {
  ...
  function SubmenuItem() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getMenuAlignmentClasses", function () {
      ...
      var isRightBottomAligned = submenuTriggerElBounding.bottom + submenuElBounding.height > bottomBoundaryElementBounding.bottom;
      return _ref = {}, _defineProperty(_ref, SUBMENU_LEFT_ALIGNED_CLASS, isLeftAligned), _defineProperty(_ref, SUBMENU_BOTTOM_ALIGNED_CLASS, isBottomAligned), _defineProperty(_ref, SUBMENU_RIGHT_BOTTOM_ALIGNED_CLASS, isRightBottomAligned), _ref;
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleMenuItemClick", function (event) {
      ...
      if (_this.submenuEl && !_this.submenuEl.contains(event.target)) {
        event.stopPropagation();
        event.preventDefault();
      }
    });
