...
describe('components/menu/SubmenuItem', function () {
  ...
  describe('handleMenuItemClick()', function () {
    test('should call onClick() and should not call stop propagation and prevent default when isDisable is false', function () {
    ...
    test('should call onClick() and stop propagation and prevent default when isDisable is false and target is submenu target element', function () {
      var onClickSpy = jest.fn();
      var stopPropagationSpy = jest.fn();
      var preventDefaultSpy = jest.fn();
      var wrapper = getWrapper({
      ...
      var menuItemEl = wrapper.find('li');
      var submenuTarget = document.createElement('div');
      var instance = wrapper.instance();
