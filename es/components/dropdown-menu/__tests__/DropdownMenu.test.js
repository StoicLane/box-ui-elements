...
describe('components/dropdown-menu/DropdownMenu', function () {
  ...
  describe('render()', function () {
    ...
    test('should render TetherComponent with attachment and targetAttachment props passed in as tetherAttachment and tetherTargetAttachment', function () {
      var tetherAttachment = 'middle left';
      var tetherTargetAttachment = 'middle right';
      var wrapper = shallow(React.createElement(DropdownMenu, {
        isRightAligned: true,
    ...
    test('should render TetherComponent with window constraints and pinned when constrainToWindowWithPin=true', function () {
      var wrapper = shallow(React.createElement(DropdownMenu, {
    ...
    test('should render TetherComponent with window constraints, pinned and scroll parent when constrainToWindowWithPin=true and constrainToScrollParent=true', function () {
      var wrapper = shallow(React.createElement(DropdownMenu, {
        constrainToScrollParent: true,
        constrainToWindowWithPin: true
      }, React.createElement(FakeButton, null), React.createElement(FakeMenu, null)));
