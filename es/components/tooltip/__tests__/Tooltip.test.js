...
describe('components/tooltip/Tooltip', function () {
  ...
  describe('render()', function () {
    ...
    test('should set aria-hidden as true if ariaHidden is true', function () {
      var wrapper = shallow(React.createElement(Tooltip, {
        isShown: true,
        text: "test",
        ariaHidden: true
    ...
    test('should not set aria-describedby when ariaHidden is true', function () {
      var wrapper = shallow(React.createElement(Tooltip, {
        isShown: true,
        text: "hi",
        ariaHidden: true
    ...
    test('should not set aria-errormessage when ariaHidden is true', function () {
      var wrapper = shallow(React.createElement(Tooltip, {
        isShown: true,
        text: "hi",
        ariaHidden: true
