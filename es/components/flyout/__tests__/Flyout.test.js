...
describe('components/flyout/Flyout', function () {
  ...
  describe('render()', function () {
    ...
    test('should render TetherComponent with window constraint when constrainToWindow=true', function () {
      var wrapper = shallow(React.createElement(Flyout, {
    ...
    test('should render TetherComponent with window constraint when constrainToWindowWithPin=true', function () {
      var wrapper = shallow(React.createElement(Flyout, {
  ...
  describe('isResponsive', function () {
    test('should have correct className when isResponsive is true', function () {
      var wrapper = shallow(React.createElement(Flyout, {
        isResponsive: true
      }, React.createElement(FakeButton, null), React.createElement(FakeOverlay, null)));
      expect(wrapper.prop('classes')).toEqual({
