...
function (_React$Component) {
  ...
  _createClass(Flyout, [{
    ...
    value: function render() {
      ...
      return React.createElement(TetherComponent, tetherProps, React.cloneElement(overlayButton, overlayButtonProps), isVisible && React.createElement(FlyoutContext.Provider, {
        value: {
