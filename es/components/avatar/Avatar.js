...
function Avatar(_ref) {
  ...
  var classes = classNames(['avatar', className, (_ref2 = {}, _defineProperty(_ref2, "avatar--".concat(size), size && SIZES[size]), _defineProperty(_ref2, 'avatar--isExternal', shouldShowExternal && isExternal), _defineProperty(_ref2, 'avatar--iconBadge', !!badgeIcon), _ref2)]); // Reset hasImageErrored state when avatarUrl changes
  ...
  if (shouldShowExternal && isExternal) {
    badge = React.createElement(GlobeBadge16, {
