...
describe('components/modal/Modal', function () {
  ...
  test.skip.each(MODAL_STORIES)('looks visually correct for small screens when button is clicked in story %s',
  /*#__PURE__*/
  function () {
      ...
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return BoxVisualTestUtils.takeModalScreenshot(id, parseInt(sizeSmallMax, 10));
