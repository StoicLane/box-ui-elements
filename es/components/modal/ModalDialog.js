...
function (_React$Component) {
  ...
  function ModalDialog() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onBackButtonClick", function (event) {
      var onRequestBack = _this.props.onRequestBack;
  ...
  _createClass(ModalDialog, [{
    ...
    value: function render() {
      var _this$props3 = this.props,
          ...
          onRequestBack = _this$props3.onRequestBack,
          onRequestClose = _this$props3.onRequestClose,
          title = _this$props3.title,
          type = _this$props3.type,
          rest = _objectWithoutProperties(_this$props3, ["className", "modalRef", "onRequestBack", "onRequestClose", "title", "type"]);
      ...
      }, onRequestBack && this.renderBackButton(), React.createElement("h2", {
