...
export var FEED_ITEM_TYPE_APP_ACTIVITY = 'app_activity';
export var FEED_ITEM_TYPE_ANNOTATION = 'annotation';
export var FEED_ITEM_TYPE_COMMENT = 'comment';
export var FEED_ITEM_TYPE_TASK = 'task';
export var FEED_ITEM_TYPE_VERSION = 'file_version';
/* -------------------- Typed Prefix-------------------------- */
...
export var FIELD_PERMISSIONS_CAN_SHARE = "".concat(FIELD_PERMISSIONS, ".can_share");
...
export var PERMISSION_CAN_RESOLVE = 'can_resolve';
...
export var DEFAULT_PREVIEW_VERSION = '2.95.0';
...
export var ERROR_CODE_FETCH_COMMENT = 'fetch_comment_error';
export var ERROR_CODE_FETCH_COMMENTS = 'fetch_comments_error';
export var ERROR_CODE_FETCH_REPLIES = 'fetch_replies_error';
...
export var ERROR_CODE_CREATE_REPLY = 'create_reply_error';
...
export var ORIGIN_PREVIEW_SIDEBAR = 'preview_sidebar';
...
export var FILE_EXTENSION_BOX_CANVAS = 'boxcanvas';
...
export var COMMENT_STATUS_OPEN = 'open';
export var COMMENT_STATUS_RESOLVED = 'resolved';
/* ------------------ Activity Filter Options ------------------ */

export var ACTIVITY_FILTER_OPTION_ALL = 'all';
export var ACTIVITY_FILTER_OPTION_RESOLVED = 'resolved';
export var ACTIVITY_FILTER_OPTION_TASKS = 'tasks';
export var ACTIVITY_FILTER_OPTION_UNRESOLVED = 'open';
/* ------------------ File Activity Types ------------------ */

export var FILE_ACTIVITY_TYPE_ANNOTATION = 'annotation';
export var FILE_ACTIVITY_TYPE_APP_ACTIVITY = 'app_activity';
export var FILE_ACTIVITY_TYPE_COMMENT = 'comment';
export var FILE_ACTIVITY_TYPE_TASK = 'task';
export var FILE_ACTIVITY_TYPE_VERSION = 'versions';
/* ----------------- Theme ---------------------------*/
