...
function (_React$PureComponent) {
  ...
  function ContentPreview(props) {
    ...
    regeneratorRuntime.mark(function _callee() {
      var _this$props2, advancedContentInsights, _this$props2$annotato, activeAnnotationId, enableThumbnailsSidebar, fileOptions, onAnnotatorEvent, onAnnotator, onContentInsightsEventReport, previewExperiences, showAnnotationsControls, tokenOrTokenFunction, rest, _this$state, file, selectedVersion, startAt, fileId, fileOpts, token, previewOptions, Preview;

      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _this$props2 = _this.props, advancedContentInsights = _this$props2.advancedContentInsights, _this$props2$annotato = _this$props2.annotatorState;
              _this$props2$annotato = _this$props2$annotato === void 0 ? {} : _this$props2$annotato;
              activeAnnotationId = _this$props2$annotato.activeAnnotationId, enableThumbnailsSidebar = _this$props2.enableThumbnailsSidebar, fileOptions = _this$props2.fileOptions, onAnnotatorEvent = _this$props2.onAnnotatorEvent, onAnnotator = _this$props2.onAnnotator, onContentInsightsEventReport = _this$props2.onContentInsightsEventReport, previewExperiences = _this$props2.previewExperiences, showAnnotationsControls = _this$props2.showAnnotationsControls, tokenOrTokenFunction = _this$props2.token, rest = _objectWithoutProperties(_this$props2, ["advancedContentInsights", "annotatorState", "enableThumbnailsSidebar", "fileOptions", "onAnnotatorEvent", "onAnnotator", "onContentInsightsEventReport", "previewExperiences", "showAnnotationsControls", "token"]);
            ...
            case 9:
              ...
              if (advancedContentInsights) {
                _this.preview.addListener('advanced_insights_report', onContentInsightsEventReport);
              }
    ...
    _defineProperty(_assertThisInitialized(_this), "getThumbnail", function (pageNumber) {
      var preview = _this.getPreview();
  ...
  _createClass(ContentPreview, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      var _this$props3 = this.props,
          advancedContentInsights = _this$props3.advancedContentInsights,
          previewExperiences = _this$props3.previewExperiences,
          token = _this$props3.token;
      var prevContentInsightsOptions = prevProps.advancedContentInsights,
          prevPreviewExperiences = prevProps.previewExperiences,
      ...
      var haveContentInsightsChanged = !isEqual(prevContentInsightsOptions, advancedContentInsights);
      ...
      if (advancedContentInsights && haveContentInsightsChanged && ((_this$preview = this.preview) === null || _this$preview === void 0 ? void 0 : _this$preview.updateContentInsightsOptions)) {
