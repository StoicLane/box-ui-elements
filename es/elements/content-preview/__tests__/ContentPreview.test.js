...
describe('elements/content-preview/ContentPreview', function () {
  ...
  describe('componentDidUpdate()', function () {
    ...
    test('should update content insights options if the isActive prop changed', function () {
      file = {
        id: '123'
      };
      props = {
      ...
      instance.destroyPreview = jest.fn();
      instance.fetchFile = jest.fn();
      var updatedContentInsightsOptions = {
        enabled: true,
        isActive: true
      };
      wrapper.setProps({
        advancedContentInsights: updatedContentInsightsOptions
      });
  ...
  describe('loadPreview()', function () {
    ...
    test.each(_templateObject2(), true, {}, false, undefined)('should call onContentInsightsEventReport $called if advancedContentInsights is $advancedContentInsights',
    /*#__PURE__*/
    function () {
      var _ref12 = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee11(_ref13) {
        var called, advancedContentInsights, onContentInsightsEventReport, wrapper, instance;
        return regeneratorRuntime.wrap(function _callee11$(_context11) {
          while (1) {
            switch (_context11.prev = _context11.next) {
              case 0:
                called = _ref13.called, advancedContentInsights = _ref13.advancedContentInsights;
                onContentInsightsEventReport = jest.fn();
                wrapper = getWrapper(_objectSpread({}, props, {
                  advancedContentInsights: advancedContentInsights,
                  onContentInsightsEventReport: onContentInsightsEventReport
                }));
                wrapper.setState({
                  file: file
                });
              ...
              case 7:
                if (called) {
                  expect(instance.preview.addListener).toHaveBeenCalledWith('advanced_insights_report', onContentInsightsEventReport);
                } else {
                  expect(instance.preview.addListener).not.toHaveBeenCalledWith('advanced_insights_report', onContentInsightsEventReport);
                }
  ...
  describe('handleAnnotationSelect', function () {
    test.each(_templateObject3(), '123', '124', 'page', 1, '124', '124', 'page', 0, '123', '124', '', 0, undefined, '124', 'page', 0)('should call onVersionChange $onVersionChangeCount times and setState $setStateCount times', function (_ref16) {
      var annotationFileVersionId = _ref16.annotationFileVersionId,
          selectedVersionId = _ref16.selectedVersionId,
          locationType = _ref16.locationType,
          setStateCount = _ref16.setStateCount;
      var annotation = {
        id: '123',
        file_version: {
  ...
  describe('getThumbnail()', function () {
    ...
    test('should call the preview getThumbnail function', function () {
      var getThumbnailStub = jest.fn();
      wrapper.setState({
        file: file
      });
      instance.preview = new global.Box.Preview();
      ...
      var pageThumbnail = instance.getThumbnail(pageNumber);
      expect(pageThumbnail).not.toBeNull();
      expect(getThumbnailStub).toBeCalledWith(pageNumber);
    });
    test('should return null if the preview viewer does not exists', function () {
      wrapper.setState({
        file: file
      });
      var pageThumbnail = instance.getThumbnail(pageNumber);
