...
function (_Component) {
  ...
  function ContentExplorer(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renameCallback", function (nameWithoutExt, extension) {
      ...
      _this.api.getAPI(type).rename(selected, name.trim(), function (updatedItem) {
        _this.setState({
    ...
    _defineProperty(_assertThisInitialized(_this), "createFolderCallback", function (name) {
      ...
      _this.api.getFolderAPI().create(id, name.trim(), function (item) {
        _this.refreshCollection();
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSharedLinkSuccess",
    /*#__PURE__*/
    function () {
      var _ref4 = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee2(item) {
        var currentCollection, updatedItem;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                currentCollection = _this.state.currentCollection;
                updatedItem = item; // if there is no shared link, create one with enterprise default access
                ...
                _context2.next = 5;
                return _this.api.getAPI(item.type).share(item, undefined, function (sharedItem) {
                  updatedItem = sharedItem;
                });

              case 5:
                _this.updateCollection(currentCollection, updatedItem, function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "isFocusOnItem", function () {
      var _document$activeEleme;

      var focusedElementClassList = (_document$activeEleme = document.activeElement) === null || _document$activeEleme === void 0 ? void 0 : _document$activeEleme.classList;
    ...
    _defineProperty(_assertThisInitialized(_this), "onKeyDown", function (event) {
      ...
      switch (key) {
        ...
        case 'arrowdown':
          if (_this.getViewMode() === VIEW_MODE_GRID) {
            if (!_this.isFocusOnItem()) {
              focus(_this.rootElement, '.be-item-name .be-item-label', false);
              event.preventDefault();
            }
          } else {
  ...
  _createClass(ContentExplorer, [{
    ...
    value: function componentDidUpdate(_ref5, prevState) {
      var prevFolderId = _ref5.currentFolderId;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee3(collection, selectedItem) {
        var _this4 = this;

        var callback,
            newCollection,
            _newCollection$items,
            items,
            fileAPI,
            selectedId,
            newSelectedItem,
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                callback = _args3.length > 2 && _args3[2] !== undefined ? _args3[2] : noop;
                newCollection = cloneDeep(collection);
                _newCollection$items = newCollection.items, items = _newCollection$items === void 0 ? [] : _newCollection$items;
      ...
      function updateCollection(_x3, _x4) {
    ...
    value: function render() {
      ...
      var _ref6 = permissions || {},
          can_upload = _ref6.can_upload;
