...
import { CLASS_MODAL_CONTENT, CLASS_MODAL_OVERLAY, CLASS_MODAL, ACCESS_OPEN } from '../../constants';
...
var ShareDialog = function ShareDialog(_ref) {
  ...
  var allowFileAccess = function allowFileAccess() {
    onShareAccessChange(ACCESS_OPEN, item);
  };
  ...
  }, !!sharedLink && React.createElement("div", {
