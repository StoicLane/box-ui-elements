...
describe('elements/content-explorer/ContentExplorer', function () {
  ...
  describe('handleSharedLinkSuccess()', function () {
    var getApiShareMock = jest.fn().mockImplementation(function (item, access, callback) {
      return callback();
    });
    var getApiMock = jest.fn().mockReturnValue({
      share: getApiShareMock
    });
    var updateCollectionMock = jest.fn();
    var boxItem = {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return instance.handleSharedLinkSuccess(_objectSpread({}, boxItem, {
                shared_link: null
              }));
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.next = 2;
              return instance.handleSharedLinkSuccess(boxItem);
