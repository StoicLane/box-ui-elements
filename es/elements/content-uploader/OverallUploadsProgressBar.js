...
var OverallUploadsProgressBar = function OverallUploadsProgressBar(_ref) {
  var customPrompt = _ref.customPrompt,
  ...
  var message = customPrompt || messages.uploadsManagerUploadPrompt;
  var status = shouldShowPrompt ? React.createElement(FormattedMessage, message) : getUploadStatus(view);
