...
describe('elements/content-sidebar/ActivityFeed/common/activity-message', function () {
  ...
  test('should not have CollapsableMessage when `collapsableMessages` is not enabled in features', function () {
    var commentText = {
      features: {
        activityFeed: {
          collapsableMessages: {
    ...
    var wrapper = shallow(React.createElement(ActivityMessage, commentText));
    expect(wrapper.exists('CollapsableMessage')).toBe(false);
  });
  test('should have CollapsableMessage when `collapsableMessages` is enabled in features', function () {
    var commentText = {
      features: {
        activityFeed: {
          collapsableMessages: {
  ...
  test.each(_templateObject(), false, false, true, true)("given isEdited = $isEdited prop message should text \"(edited)\" be $expected", function (_ref) {
    var isEdited = _ref.isEdited,
