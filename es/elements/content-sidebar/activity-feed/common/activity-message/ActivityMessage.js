  ...
  _createClass(ActivityMessage, [{
    ...
    value: function render() {
      var _this$props3 = this.props,
          ...
          id = _this$props3.id,
          isEdited = _this$props3.isEdited,
      ...
      var MessageWrapper = isFeatureEnabled(features, 'activityFeed.collapsableMessages.enabled') ? CollapsableMessage : React.Fragment;
      ...
      }, React.createElement(MessageWrapper, null, formatTaggedMessage(commentToDisplay, id, false, getUserProfileUrl), isEdited && React.createElement("span", {
        className: "bcs-ActivityMessage-edited"
      }, React.createElement(FormattedMessage, messages.activityMessageEdited))), translationEnabled ? this.getButton(isTranslation) : null);
    }
  }]);
