...
var AnnotationActivity = function AnnotationActivity(_ref) {
  var currentUser = _ref.currentUser,
      ...
      onStatusChange = _ref$onStatusChange === void 0 ? noop : _ref$onStatusChange;
  ...
  var canDelete = permissions.can_delete,
      ...
      canResolve = permissions.can_resolve;
  ...
  var handleStatusChange = function handleStatusChange(newStatus) {
    return onStatusChange(id, newStatus, permissions);
  };
  ...
  }), hasVersions && React.createElement(AnnotationActivityLink, {
