...
describe('elements/content-sidebar/ActivityFeed/annotations/AnnotationActivityMenu', function () {
  ...
  test('should render the resolve annotation activity menu item if canResolve is true for unresolved item', function () {
    var wrapper = getWrapper({
      canResolve: true,
      status: 'open'
    });
  ...
  test('should render the unresolve annotation activity menu item if canResolve is true for resolved item', function () {
    var wrapper = getWrapper({
      canResolve: true,
      status: 'resolved'
    });
  ...
  test('should render resin tags for unresolve activity', function () {
    var wrapper = getWrapper({
      canResolve: true,
      status: 'resolved'
    });
