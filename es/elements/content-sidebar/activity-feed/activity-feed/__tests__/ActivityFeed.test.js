...
import { FEED_ITEM_TYPE_ANNOTATION, FEED_ITEM_TYPE_COMMENT, FEED_ITEM_TYPE_TASK, FEED_ITEM_TYPE_VERSION } from '../../../../../constants';
...
describe('elements/content-sidebar/ActivityFeed/activity-feed/ActivityFeed', function () {
  ...
  test('shouold render correct data-testid if has been scrolled', function () {
    var wrapper = getWrapper({
      feedItems: [{
        type: FEED_ITEM_TYPE_COMMENT
      }]
  ...
  describe('setSelectedItem()', function () {
    test('should call setState if hasReplies = true', function () {
      var wrapper = getWrapper({
        hasReplies: true
      });
      var instance = wrapper.instance();
    ...
    test.each(_templateObject2(), false, undefined)('should not call setState if hasReplies = $hasRepplies', function (_ref2) {
  ...
  describe('isFeedItemActive()', function () {
    test.each(_templateObject3(), '123', 'comment', null, true, '456', 'annotation', null, false, '456', 'comment', null, false, '123', 'comment', '456', false, '456', 'annotation', '456', true, '456', 'comment', '456', true)('should return $expected given id=$id and type=$type', function (_ref3) {
      var id = _ref3.id,
          type = _ref3.type,
      ...
      expect(instance.isFeedItemActive({
        id: id,
        type: type
      })).toBe(expected);
    });
  });
  describe('isCommentFeedItemActive()', function () {
    test.each(_templateObject4(), [{
      ...
      id: '456'
    }], true, true, [], false, false, [], true, true, undefined, false, false, undefined, true, true)('should return $expected when replies=replies and isFeedItemActive results with $isFeedItemActiveResult', function (_ref4) {
      var replies = _ref4.replies,
          isFeedItemActiveResult = _ref4.isFeedItemActiveResult,
          expected = _ref4.expected;
      var wrapper = getWrapper({
        activeFeedEntryId: '123'
      });
      var instance = wrapper.instance();
      instance.isFeedItemActive = jest.fn().mockImplementation(function () {
        return isFeedItemActiveResult;
      });
      expect(instance.isCommentFeedItemActive({
        id: 'foo',
        replies: replies,
        type: 'bar'
      })).toBe(expected);
