...
var SidebarNav = function SidebarNav(_ref) {
  ...
  var hasBoxSign = false; // const { enabled: hasBoxSign } = useFeatureConfig('boxSign');
  ...
  }, React.createElement(IconMetadataThick, null))), hasBoxSign && React.createElement("div", {
    className: "bcs-SidebarNav-secondary"
  }, React.createElement(SidebarNavSign, null)), hasAdditionalTabs && React.createElement("div", {
