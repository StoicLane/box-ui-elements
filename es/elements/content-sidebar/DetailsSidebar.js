...
import SidebarClassification from './SidebarClassification'; // $FlowFixMe typescript component
  ...
  _createClass(DetailsSidebar, [{
    ...
    value: function componentDidMount() {
      var _this$props = this.props,
          hasAccessStats = _this$props.hasAccessStats,
          hasContentInsights = _this$props.hasContentInsights,
          fetchContentInsights = _this$props.fetchContentInsights;
      this.fetchFile();
    ...
    value: function componentDidUpdate(_ref) {
      var prevHasAccessStats = _ref.hasAccessStats,
          prevHasContentInsights = _ref.hasContentInsights;
      var _this$props2 = this.props,
          hasAccessStats = _this$props2.hasAccessStats,
          hasContentInsights = _this$props2.hasContentInsights,
          fetchContentInsights = _this$props2.fetchContentInsights; // Component visibility props such as hasAccessStats can sometimes be flipped after an async call

      var hasAccessStatsChanged = prevHasAccessStats !== hasAccessStats;
      var hasContentInsightsChanged = prevHasContentInsights !== hasContentInsights;
    ...
    value: function render() {
      var _this$props5 = this.props,
          classification = _this$props5.classification,
          contentInsights = _this$props5.contentInsights,
          elementId = _this$props5.elementId,
          hasProperties = _this$props5.hasProperties,
          hasNotices = _this$props5.hasNotices,
          hasAccessStats = _this$props5.hasAccessStats,
          hasClassification = _this$props5.hasClassification,
          hasContentInsights = _this$props5.hasContentInsights,
          hasRetentionPolicy = _this$props5.hasRetentionPolicy,
          hasVersions = _this$props5.hasVersions,
          onAccessStatsClick = _this$props5.onAccessStatsClick,
          onVersionHistoryClick = _this$props5.onVersionHistoryClick,
          onClassificationClick = _this$props5.onClassificationClick,
          onContentInsightsClick = _this$props5.onContentInsightsClick,
          onRetentionPolicyExtendClick = _this$props5.onRetentionPolicyExtendClick,
          retentionPolicy = _this$props5.retentionPolicy;
      ...
      }, accessStatsError)), file && hasContentInsights && React.createElement(SidebarContentInsights, {
        contentInsights: contentInsights,
        onContentInsightsClick: onContentInsightsClick
      }), file && hasProperties && React.createElement(SidebarSection, {
