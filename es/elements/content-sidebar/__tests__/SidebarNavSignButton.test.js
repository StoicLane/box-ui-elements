...
import SidebarNavSignButton from '../SidebarNavSignButton'; // @ts-ignore Module is written in Flow

import TargetedClickThroughGuideTooltip from '../../../features/targeting/TargetedClickThroughGuideTooltip';
import Tooltip from '../../../components/tooltip';
describe('elements/content-sidebar/SidebarNavSignButton', function () {
  var getWrapper = function getWrapper() {
    var props = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    return shallow(React.createElement(SidebarNavSignButton, props)).dive();
  };
  ...
  test.each(_templateObject3(), 'shield-download', true, 'This action is unavailable due to a security policy.', 'shared-link', true, 'This action is unavailable due to a security policy.', 'shield-sign', true, 'This action is unavailable due to a security policy.', 'watermark', true, 'This action is unavailable, because the file is watermarked.', '', false, 'Request Signature')('should render the correct main tooltip and ftux tooltip based on the blockedReason', function (_ref3) {
