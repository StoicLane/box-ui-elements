...
jest.mock('../SidebarContentInsights', function () {
...
describe('elements/content-sidebar/DetailsSidebar', function () {
  ...
  describe('render()', function () {
    ...
    test('should render DetailsSidebar with content insights', function () {
      var wrapper = getWrapper({
        contentInsights: {},
  ...
  describe('componentDidMount()', function () {
    ...
    test('should fetch the content insights', function () {
      var fetchContentInsights = jest.fn();
      wrapper.setProps({
        fetchContentInsights: fetchContentInsights,
        hasClassification: true,
        hasContentInsights: true
      });
      instance.componentDidMount();
  ...
  describe('componentDidUpdate()', function () {
    ...
    test('should fetch the content insights data if the content insights visibility changed', function () {
      var fetchContentInsights = jest.fn();
      wrapper.setProps({
        fetchContentInsights: fetchContentInsights,
        hasContentInsights: true
