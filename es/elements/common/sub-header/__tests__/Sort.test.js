...
describe('elements/common/sub-header/Sort', function () {
  test('should render a button and menu with 4 select menu items', function () {
  ...
  test('should only have one option selected', function () {
    var wrapper = shallow(React.createElement(Sort, {
      onSortChange: jest.fn(),
      sortBy: "date",
