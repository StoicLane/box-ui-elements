...
describe('elements/content-picker/Footer', function () {
  ...
  describe('render()', function () {
    ...
    test('should render footer with disabled button', function () {
      var buttons = getWrapper().find('Button');
      var chooseButton = buttons.at(1); // https://www.w3.org/WAI/ARIA/apg/patterns/button/
    ...
    test('should render Footer buttons with aria-label', function () {
      var buttons = getWrapper().find('Button');
