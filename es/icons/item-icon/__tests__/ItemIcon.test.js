...
describe('icons/item-icon/ItemIcon', function () {
  ...
  describe.each(['audio', 'bookmark', 'boxcanvas', 'boxnote', 'code', 'default', 'document', 'docuworks-binder', 'docuworks-file', 'dwg', 'excel-spreadsheet', 'folder-collab', 'folder-external', 'folder-plain', 'google-docs', 'google-sheets', 'google-slides', 'illustrator', 'image', 'indesign', 'keynote', 'numbers', 'pages', 'pdf', 'photoshop', 'powerpoint-presentation', 'presentation', 'spreadsheet', 'text', 'threed', 'vector', 'video', 'word-document', 'zip'])('render()', function (iconType) {
