  ...
  function SharedLinkSettingsModal(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onSubmit", function (event) {
      ...
      var _this$state = _this.state,
          expirationFormattedDate = _this$state.expirationFormattedDate,
    ...
    _defineProperty(_assertThisInitialized(_this), "onExpirationDateChange", function (date, formattedDate) {
      _this.setState({
        expirationDate: date,
