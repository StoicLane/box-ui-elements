...
function CollapsibleSidebarLogo(props) {
  var badge = props.badge,
      ...
      _props$isLogoVisible = props.isLogoVisible,
      isLogoVisible = _props$isLogoVisible === void 0 ? true : _props$isLogoVisible,
  ...
  return React.createElement("div", {
    ...
    expanded: expanded,
    expandedElement: React.createElement(React.Fragment, null, toggleButton, isLogoVisible && React.createElement(LinkBase, _extends({
