...
describe('features/content-explorer/content-explorer/ContentExplorer', function () {
  ...
  describe('render()', function () {
    ...
    test('should render ContentExplorerIncludeSubfolders when passed includeSubfoldersProps', function () {
      var wrapper = renderComponent({
        includeSubfoldersProps: {}
      });
      expect(wrapper.exists('ContentExplorerIncludeSubfolders')).toBe(true);
    });
    test('should not render ContentExplorerIncludeSubfolders without includeSubfoldersProps', function () {
      var wrapper = renderComponent();
    ...
    test('should render with action buttons enabled in MULTI_SELECT mode if there is no selection made when isNoSelectionAllowed is true', function () {
      var items = [{
        id: '1',
        name: 'item1'
      }, {
  ...
  describe('onSelectItem', function () {
    ...
    test('should set isSelectAllChecked to true if all displayed items are selected and isSelectAllAllowed is true', function () {
      var clickedItemIndex = 0;
      var clickedItemIndex2 = 1;
      var clickedItemIndex3 = 2;
      var items = [{
        id: '1',
        name: 'item1'
      }, {
    ...
    test('should set isSelectAllChecked to false if an item is unchecked while isSelectAllChecked is true', function () {
      var clickedItemIndex = 0;
      var clickedItemIndex2 = 1;
      var items = [{
        id: '1',
      ...
      var selectedItems = {
        '1': items[clickedItemIndex],
        '2': items[clickedItemIndex2]
      };
      var wrapper = renderComponent({
        items: items,
        isSelectAllAllowed: true,
