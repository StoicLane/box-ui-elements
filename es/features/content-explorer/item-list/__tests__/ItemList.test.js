...
describe('features/content-explorer/item-list/ItemList', function () {
  ...
  describe('itemRowRenderer', function () {
    test('should use defaultTableRowRenderer when itemRowRenderer is not provided', function () {
      var items = [{
        id: '1',
        name: 'item1'
      }, {
    ...
    test('should use itemRowRenderer when specified', function () {
      var items = [{
        id: '1',
        name: 'item1'
      }, {
      ...
      var itemRowRenderer = function itemRowRenderer(params) {
  ...
  describe('additionalColumns', function () {
    test('should render extra column', function () {
      var items = [{
        id: '1',
        name: 'item1'
      }, {
      ...
      var additionalColumns = [React.createElement(Column, {
        key: "accessLevel",
  ...
  describe('headerHeight', function () {
    ...
    test('should display header row with specified height when item list is not empty', function () {
      var headerHeight = 30;
      var wrapper = renderComponent({
        headerHeight: headerHeight,
        items: items
      });
      var header = wrapper.find('.ReactVirtualized__Table__headerRow');
      expect(header.props().style.height).toBe(headerHeight);
    });
    test('should not display header row with specified height when item list is empty and noItemsRenderer is present', function () {
      var headerHeight = 30;
  ...
  describe('headerRenderer', function () {
    ...
    test('should use headerRenderer when specified if item list is not empty', function () {
      var wrapper = renderComponent({
      ...
      var headerRow = wrapper.find("[data-testid='customHeader']");
      expect(headerRow.length).toBe(1);
    });
    test('should not use headerRenderer when specified if item list is empty and noItemsRenderer is present', function () {
      var noItemsRenderer = function noItemsRenderer() {
        return React.createElement(React.Fragment, null);
      };
