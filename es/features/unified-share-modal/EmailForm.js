...
function (_React$Component) {
  ...
  function EmailForm(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleRemoveRestrictedContacts", function () {
      ...
      var _partition = partition(selectedContacts, function (contact) {
        return _this.isRestrictedContact(contact);
      }),
    ...
    _defineProperty(_assertThisInitialized(_this), "validateContactsRestrictions", function () {
      ...
      var _this$props5 = _this.props,
          ...
          restrictedEmails = _this$props5.restrictedEmails,
          restrictedGroups = _this$props5.restrictedGroups;
      var hasRestrictedCollabs = hasRestrictedContacts(selectedContacts, restrictedEmails, restrictedGroups);
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSubmit", function (event) {
      ...
      selectedContacts.forEach(function (contact) {
        ...
        if (type === 'group') {
          ...
          if (_this.isRestrictedContact(contact)) {
    ...
    _defineProperty(_assertThisInitialized(_this), "filterSentEmails", function (sentEmails) {
      _this.props.updateSelectedContacts(_this.props.selectedContacts.filter(function (_ref) {
    ...
    _defineProperty(_assertThisInitialized(_this), "isValidContactPill", function (contactPill) {
      ...
      if (isString(contactPill)) {
        ...
        isValid = !_this.isRestrictedContact(contactPill) || hasRequiredJustification;
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "getContactPillClassName", function (contactPill) {
      ...
      var isWaivedPill = _this.isRestrictedContact(contactPill) && hasRequiredJustification;
      return isWaivedPill ? 'is-waived' : '';
    });

    _defineProperty(_assertThisInitialized(_this), "isRestrictedContact", function (contact) {
      var _this$props7 = _this.props,
          restrictedEmails = _this$props7.restrictedEmails,
          restrictedGroups = _this$props7.restrictedGroups;
  ...
  _createClass(EmailForm, [{
    ...
    value: function render() {
      ...
      var _this$props8 = this.props,
          cancelButtonProps = _this$props8.cancelButtonProps,
          children = _this$props8.children,
          collabRestrictionType = _this$props8.collabRestrictionType,
          config = _this$props8.config,
          contactsFieldAvatars = _this$props8.contactsFieldAvatars,
          contactsFieldDisabledTooltip = _this$props8.contactsFieldDisabledTooltip,
          contactsFieldLabel = _this$props8.contactsFieldLabel,
          inlineNotice = _this$props8.inlineNotice,
          isContactsFieldEnabled = _this$props8.isContactsFieldEnabled,
          isExternalUserSelected = _this$props8.isExternalUserSelected,
          getContactAvatarUrl = _this$props8.getContactAvatarUrl,
          getContacts = _this$props8.getContacts,
          intl = _this$props8.intl,
          isExpanded = _this$props8.isExpanded,
          isFetchingJustificationReasons = _this$props8.isFetchingJustificationReasons,
          isRestrictionJustificationEnabled = _this$props8.isRestrictionJustificationEnabled,
          justificationReasons = _this$props8.justificationReasons,
          messageProps = _this$props8.messageProps,
          onPillCreate = _this$props8.onPillCreate,
          recommendedSharingTooltipCalloutName = _this$props8.recommendedSharingTooltipCalloutName,
          restrictedEmails = _this$props8.restrictedEmails,
          restrictedGroups = _this$props8.restrictedGroups,
          selectedContacts = _this$props8.selectedContacts,
          sendButtonProps = _this$props8.sendButtonProps,
          showEnterEmailsCallout = _this$props8.showEnterEmailsCallout,
      ...
      var shouldRenderContactRestrictionNotice = isExpanded && hasRestrictedContacts(selectedContacts, restrictedEmails, restrictedGroups);
