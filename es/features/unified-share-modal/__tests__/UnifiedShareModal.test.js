...
describe('features/unified-share-modal/UnifiedShareModal', function () {
  ...
  describe('render()', function () {
    ...
    test('should render a component with onLoadSharedLink callback called when shared link data returns', function () {
      var onLoadSharedLinkMock = jest.fn();
      var wrapper = getWrapper({
        trackingProps: {
          modalTracking: {
            onLoadSharedLink: onLoadSharedLinkMock
          }
        }
      });
      wrapper.setProps({
