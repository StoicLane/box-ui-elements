...
describe('features/unified-share-modal/utils/hasRestrictedContacts', function () {
  var contacts = [{
    id: 12345,
    text: 'X User',
    type: 'group'
  ...
  test('should return false when no restricted emails are found within contacts', function () {
  ...
  test('should return false when no restricted groups are found within contacts', function () {
  ...
  test('should return true when at least one restricted email is found within contacts', function () {
    var restrictedEmails;
  ...
  test('should return true when at least one restricted group is found within contacts', function () {
