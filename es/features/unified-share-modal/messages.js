...
var messages = defineMessages({
  ...
  justifiableContactRestrictionNotice: {
    ...
    "defaultMessage": "This content requires a business justification for {count, plural, one {{count} invitation} other {{count} invitations}}. Please select a business justification below."
  },
  ...
  contactRestrictionNotice: {
    ...
    "defaultMessage": "{count, plural, one {{count} invitation} other {{count} invitations}} cannot be sent because external collaboration is restricted due to the applied security policy."
  },
  ...
  contactRestrictionNoticeInformationBarrier: {
    ...
    "defaultMessage": "{count, plural, one {{count} invitation} other {{count} invitations}} cannot be sent due to a security policy."
  },
  ...
  setLevelOfCollabAccess: {
    ...
    "defaultMessage": "Set the level of {collaboratorAccess} and increase security through one of our paid plans. {upgradeLink}"
  },
  collabAccess: {
