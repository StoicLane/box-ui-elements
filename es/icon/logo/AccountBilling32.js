...
var AccountBilling32 = function AccountBilling32(props) {
  return React.createElement(AccessibleSVG, _extends({
    ...
    fillRule: "evenodd",
    clipRule: "evenodd",
    d: "M25 14.2v6.5c0 .718-.576 1.3-1.286 1.3H8.286C7.576 22 7 21.418 7 20.7v-6.5h18zm-4.5 3.9h-1.286c-.857 0-.857 1.3 0 1.3H20.5c.858 0 .858-1.3 0-1.3zm-3.857 0h-6.429c-.857 0-.857 1.3 0 1.3h6.429c.857 0 .857-1.3 0-1.3zM7 10.3C7 9.582 7.576 9 8.286 9h15.428c.71 0 1.286.582 1.286 1.3v1.3H7v-1.3z",
    fill: "#fff"
  }));
};

export default AccountBilling32;
//# sourceMappingURL=AccountBilling32.js.map