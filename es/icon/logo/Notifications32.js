...
var Notifications32 = function Notifications32(props) {
  return React.createElement(AccessibleSVG, _extends({
    ...
    fillRule: "evenodd",
    clipRule: "evenodd",
    d: "M17.75 22.333c0 .921-.783 1.667-1.75 1.667s-1.75-.746-1.75-1.667h3.5zM16.003 9c.96 0 1.75.75 1.75 1.667 2.079.47 3.497 2.083 3.497 5v2.491c0 .473.35 1.011.781 1.22l.094.044c.875.411.875 1.249.875 1.249v.829H9v-.836a1.48 1.48 0 01.878-1.249l.093-.044c.424-.202.779-.748.779-1.212v-2.492c0-2.917 1.136-4.534 3.5-5 0-.917.794-1.667 1.753-1.667z",
    fill: "#fff"
  }));
};

export default Notifications32;
//# sourceMappingURL=Notifications32.js.map