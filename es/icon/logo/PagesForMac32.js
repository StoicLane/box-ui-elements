...
var PagesForMac32 = function PagesForMac32(props) {
  return React.createElement(AccessibleSVG, _extends({
    ...
    d: "M32 0H0v32h32V0z",
    fill: "url(#prefix__paint0_linear_56_33)"
  }), React.createElement("path", {
    fillRule: "evenodd",
    clipRule: "evenodd",
    d: "M26.402 26.4H9.2l-2.4 1.067h19.602a.532.532 0 00.532-.532v-.003a.532.532 0 00-.532-.532z",
    fill: "#FFC78A"
  }), React.createElement("path", {
    fillRule: "evenodd",
    clipRule: "evenodd",
    d: "M5.644 25.51l-.674 1.156a.267.267 0 00.365.364l1.155-.674-.846-.846zM6.038 24.838l1.124 1.124c.083.083.21.102.314.047a12.988 12.988 0 003.152-2.315l5.8-5.8-2.322-2.322-5.8 5.8a12.987 12.987 0 00-2.315 3.152.267.267 0 00.047.314zM16.961 17.361a.267.267 0 00.377 0l1.329-1.36c7.467-7.468 8-9.334 7.333-10-.666-.668-2.533-.134-10 7.332l-1.36 1.329a.267.267 0 000 .377l2.321 2.322z",
    fill: "#fff"
  })), React.createElement("defs", null, React.createElement("linearGradient", {
    id: "prefix__paint0_linear_56_33",
    x1: 16,
    y1: 31.703,
    x2: 16,
    y2: 1.331,
