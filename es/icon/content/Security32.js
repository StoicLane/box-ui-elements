...
var Security32 = function Security32(props) {
  return React.createElement(AccessibleSVG, _extends({
    ...
    fillRule: "evenodd",
    clipRule: "evenodd",
    d: "M12 11v2h-1a2 2 0 00-2 2v8a2 2 0 002 2h10a2 2 0 002-2v-8a2 2 0 00-2-2h-1v-2a4 4 0 00-8 0zm6 2v-2a2 2 0 10-4 0v2h4z",
    fill: "#fff"
  }), React.createElement("path", {
    d: "M15.436 22a.63.63 0 00.566-.301l2.867-4.637a.907.907 0 00.1-.22.735.735 0 00.031-.204.632.632 0 00-.175-.456.585.585 0 00-.44-.182.57.57 0 00-.301.075.742.742 0 00-.236.261l-2.422 4.076-1.34-1.174a.577.577 0 00-.474-.238.58.58 0 00-.438.182.64.64 0 00-.174.46c0 .081.013.159.04.232a.793.793 0 00.14.234l1.713 1.626a.671.671 0 00.543.266z",
    fill: vars.bdlDarkBlue
  }));
};

export default Security32;
//# sourceMappingURL=Security32.js.map