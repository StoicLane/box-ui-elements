...
var Notifications32 = function Notifications32(props) {
  return React.createElement(AccessibleSVG, _extends({
    ...
    fillRule: "evenodd",
    clipRule: "evenodd",
    d: "M18 21.8a1.6 1.6 0 11-3.2 0H18zM16.402 9c.878 0 1.6.72 1.6 1.6 1.901.451 3.198 2 3.198 4.8v2.392c0 .454.32.97.714 1.17l.086.044c.8.394.8 1.198.8 1.198V21H10v-.802a1.43 1.43 0 01.802-1.2l.086-.042c.387-.194.712-.718.712-1.163V15.4c0-2.8 1.038-4.352 3.2-4.8 0-.88.726-1.6 1.602-1.6z",
    fill: "#fff"
  }));
};
