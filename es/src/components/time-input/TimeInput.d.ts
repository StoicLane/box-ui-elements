...
declare type TimeInputEventHandler = ({ displayTime, hours, minutes, }: {
    displayTime: string;
    hours: number;
    minutes: number;
}) => void;
...
declare const TimeInput: ({ className, errorTooltipPosition, hideLabel, initialDate, innerRef, intl, isRequired, label, onBlur, onChange, onError, }: TimeInputProps) => JSX.Element;
